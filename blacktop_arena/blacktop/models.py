...
class Game(models.Model):
    ...
    winner = models.ForeignKey(
        User, related_name='winner', null=True, default=None, on_delete=models.SET_DEFAULT, blank=True
    )
    ...
    player_one = models.ForeignKey(User, related_name='player_one', null=True, default=None, on_delete=models.SET_DEFAULT, blank=True)
    player_two = models.ForeignKey(User, related_name='player_two', null=True, default=None, on_delete=models.SET_DEFAULT, blank=True)
